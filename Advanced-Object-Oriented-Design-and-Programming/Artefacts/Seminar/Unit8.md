...
with no edits to calculate_total_price. My full post, code and the exchanges with my peers are in the Collaborative Discussion section [link]. This exercise connected directly to my final artefact, 
